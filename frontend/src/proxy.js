...
export async function proxy(request) {
  ...
  try {
    ...
    // rather than crashing and causing a refresh loop
...
export const config = {
  // Only intercept routes that need server-side role enforcement.
  // /profile and /settings use createBrowserClient (localStorage) so
  // they MUST NOT be matched here — the server-side cookie check would
  // always fail and redirect logged-in users to /login.
